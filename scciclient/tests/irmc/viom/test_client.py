...
class VIOMConfigurationTestCase(testtools.TestCase):
    ...
    def test_terminate(self, mock_set):
    ...
    @staticmethod
    def _create_json_for_apply(slot_json):
        return {
    ...
    def test_set_iscsi_volume_to_onboard_lan(self, mock_set):
        self.configurator.set_iscsi_volume('LAN0-9',
                                           'iqn-2017-04.com.fujitsu:01',
                                           '192.168.11.11', '255.255.255.0',
                                           'iqn-2017-04.com.fujitsu:11',
                                           '192.168.22.22')
        port = {
            '@PortIdx': 9,
            'PortEnable': True,
    ...
    def test_set_iscsi_volume_to_cna_card(self, mock_set):
        self.configurator.set_iscsi_volume('CNA1-2',
                                           'iqn-2017-04.com.fujitsu:01',
                                           '192.168.11.11', '255.255.255.0',
                                           'iqn-2017-04.com.fujitsu:11',
                                           '192.168.22.22')
    ...
    def test_set_iscsi_volume_to_cna_card_chap(self, mock_set):
        self.configurator.set_iscsi_volume('CNA9-9',
                                           'iqn-2017-04.com.fujitsu:01',
                                           '192.168.11.11', '255.255.255.0',
                                           'iqn-2017-04.com.fujitsu:11',
                                           '192.168.22.22',
    ...
    def test_set_iscsi_volume_to_cna_card_mutual_chap(self, mock_set):
        self.configurator.set_iscsi_volume('CNA2-1',
                                           'iqn-2017-04.com.fujitsu:01',
                                           '192.168.11.11', '255.255.255.0',
                                           'iqn-2017-04.com.fujitsu:11',
                                           '192.168.22.22',
