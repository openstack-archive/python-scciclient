...
class SCCITestCase(testtools.TestCase):
    ...
    def test_get_capabilities_properties(self,
        ...
        self.assertEqual(expected, result)
        tpm_mock.assert_called_once_with(self.irmc_info, temp_dir)
    ...
    def test_get_capabilities_properties_scci_client_error(self,
        ...
        ipmiexec_mock.return_value = None
        ...
        e = self.assertRaises(scci.SCCIClientError,
                              ...
                              fpga_ids,
                              temp_dir)
        self.assertEqual('SNMP operation \'GET\' failed: error', str(e))
        ipmiexec_mock.assert_called_once_with(self.irmc_info,
                                              mock.ANY,
                                              temp_dir)
