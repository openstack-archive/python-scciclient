...
class IpmiTestCase(testtools.TestCase):
    ...
    def test_exec_ipmitool(self, exec_mock):
        ...
        actual_out = ipmi.exec_ipmitool(self.info, cmd, temp_dir)
    ...
    def test_get_tpm_status_true(self, exec_mock):
        ...
        actual_out = ipmi.get_tpm_status(self.info, temp_dir)
        self.assertEqual(True, actual_out)
        exec_mock.assert_called_once_with(self.info, cmd, temp_dir)
    ...
    def test_get_gpu_fpgas(self, exec_mock):
        ...
        actual_out = ipmi.get_gpu_fpgas(self.info, gpu_ids, fpga_ids, temp_dir)
        self.assertEqual((1, 0), actual_out)
        exec_mock.assert_has_calls([mock.call(self.info, cmd1, temp_dir),
                                    mock.call(self.info, cmd2, temp_dir)])
