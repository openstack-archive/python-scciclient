...
class ELCMTestCase(testtools.TestCase):
    ...
    def test_set_bios_configuration(self, restore_bios_config_mock):
        settings = [{
            "name": "PxeBootOptionRetry",
            "value": True
        }, {
            "name": "HyperThreadingEnabled",
            "value": True
        }, {
            "name": "ExecuteDisableBitEnabled",
            "value": True
        }]
        bios_config_data = {
            'Server': {
    ...
    def test_set_bios_configuration_not_found(self):
        ...
        self.assertRaises(elcm.BiosConfigNotFound,
                          elcm.set_bios_configuration,
                          self.irmc_info, settings=settings)
