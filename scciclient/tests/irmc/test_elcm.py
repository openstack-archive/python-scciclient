...
class ELCMTestCase(testtools.TestCase):
    ...
    def test_delete_raid_adapter_without_existing_logical_drive(
        ...
        result = elcm.delete_raid_configuration(self.irmc_info)
        self.assertEqual(expected_raid_profile, result)
    ...
    def test_pass_raised_elcm_profile_not_found(
        ...
        self.assertRaises(elcm.ELCMProfileNotFound, elcm_profile_delete_mock)
