...
class ELCMTestCase(testtools.TestCase):
    ...
    @mock.patch.object(elcm.eventlet, 'sleep')
    def test__process_session_bios_config_get_ok(self, mock_sleep,
        ...
        elcm._process_session_bios_config(operation='GET',
                                          session_id=session_id,
    ...
    def test__process_session_bios_config_set_ok(self, mock_sleep,
        ...
        elcm._process_session_bios_config(operation='SET',
                                          session_id=session_id,
                                          irmc_info=self.irmc_info,
                                          callback=_callback)
    ...
    def test__process_session_bios_config_timeout(self, mock_sleep,
        ...
        def _callback(result):
            ...
            self.assertIsInstance(result['error'], elcm.ELCMSessionTimeout)
    ...
    def test__process_session_bios_config_error(self,
        ...
        def _callback(result):
            self.assertEqual(False, result['success'])
            self.assertIsInstance(result['error'], scci.SCCIClientError)
    ...
    @mock.patch.object(elcm, 'elcm_session_get_status')
    @mock.patch.object(elcm.eventlet, 'sleep')
    def test_get_bios_config_ok(self, mock_sleep, mock_session_get,
        ...
        # NOTE: use async=False to run the func in the same thread
        elcm.get_bios_config(irmc_info=self.irmc_info,
                             callback=_callback,
                             async=False)
    ...
    @mock.patch.object(elcm, 'elcm_session_get_status')
    @mock.patch.object(elcm.eventlet, 'sleep')
    def _test_set_bios_config_ok(self, mock_sleep, mock_session_get,
        ...
        # NOTE: use async=False to run the func in the same thread
        elcm.set_bios_config(bios_config=bios_cfg,
                             irmc_info=self.irmc_info,
                             callback=_callback,
                             async=False)
    ...
    def test_set_bios_config_ok_with_dict(self):
        bios_cfg = {
            'Server': {
                'SystemConfig': {
                    'BiosConfig': {
        ...
        self._test_set_bios_config_ok(bios_cfg=bios_cfg)

    def test_set_bios_config_ok_with_str(self):
        bios_cfg = ('{"Server":'
                    '  {"SystemConfig":'
                    '    {"BiosConfig":'
                    '      {'
    ...
    def _test_set_bios_config_invalid_input(self, bios_cfg):
        def _callback(result):
            self.assertEqual(False, result['success'])
            self.assertIsInstance(result['error'], scci.SCCIInvalidInputError)
    ...
    def test_set_bios_config_invalid_input_dict(self):
        bios_cfg = {
            'Server': {
                'SystemConfig': {
                }
        ...
        self._test_set_bios_config_invalid_input(bios_cfg=bios_cfg)

    def test_set_bios_config_invalid_input_str(self):
        bios_cfg = '{"key": "val"}'
        self._test_set_bios_config_invalid_input(bios_cfg=bios_cfg)
