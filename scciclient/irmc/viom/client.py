...
def _create_iscsi_boot(initiator_iqn, initiator_ip, initiator_netmask,
                       ...
                       boot_prio=1, chap_user=None, chap_secret=None,
...
class VIOMConfiguration(object):
    ...
    def set_iscsi_volume(self, port_id,
                         ...
                         target_lun=0, boot_prio=1, chap_user=None,
                         chap_secret=None, mutual_chap_secret=None):
        ...
        :param initiator_netmask: Netmask of initiator as integer..
        ...
        iscsi_boot = _create_iscsi_boot(
            initiator_iqn, initiator_ip, initiator_netmask,
            target_iqn, target_ip, target_port, target_lun, boot_prio,
        ...
        for port_idx in range(1, port_handler.port_idx):
            ...
            if not self._find_port(pad_handler):
                self._add_port(pad_handler,
                               pad_handler.create_lan_port(port_enable=False))
