...
def get_capabilities_properties(d_info,
    ...
    :param snmp_lib: a SNMP client object
    ...
    snmp_client = snmp_lib.SNMPClient(d_info['irmc_address'],
    ...
    c['irmc_firmware_version'] = snmp.get_irmc_firmware_version(snmp_client)
