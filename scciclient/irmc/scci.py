...
def get_capabilities_properties(d_info, snmp, capa_keys, gpu_ids, fpga_ids):
    ...
    :param snmp: a SNMP client object
    ...
    c['rom_firmware_version'] = ipmi.get_bios_firmware_version(snmp_client)
    c['irmc_firmware_version'] = ipmi.get_irmc_firmware_version(snmp_client)
    c['server_model'] = ipmi.get_server_model(snmp_client)
    c['pci_gpu_devices'], c['cpu_fpgas'] = ipmi.get_gpu_fpgas(d_info, gpu_ids,
                                                              fpga_ids)
