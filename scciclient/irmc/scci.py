...
def get_capabilities_properties(d_info,
    ...
    :param pci_device_ids: the string contains pairs of <vendorID>/<deviceID> for
    GPU
    :param extra: the dictionary of additional parameters.
    ...
    try:
        ...
        if extra and extra.get('sleep_flag', False):
            time.sleep(5)
