...
def _parse_elcm_response_body_as_json(response):
    ...
    # NOTE: requests on python2 fails to parse the response body as json
    # even the response data is correct. cURL and requests on python 3
    # work correctly. Response content from requests on python2 seems
    # to be mix of some-text and json text with structure:
    # --------------------------------------
    # Text line 1
    # Text line 2
    # Text line 3
